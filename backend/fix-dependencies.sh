...
pip install "asyncpg>=0.25.0,<0.30.0"
pip install "alembic>=1.10.0,<1.15.0"

# 缓存
pip install "redis>=4.0.0,<6.0.0"
pip install "aioredis>=2.0.0,<3.0.0"

# 认证和安全
pip install "python-jose[cryptography]>=3.0.0,<4.0.0"
pip install "passlib[bcrypt]>=1.7.0,<2.0.0"
pip install "python-multipart>=0.0.5,<1.0.0"

# 邮件和模板
pip install "aiosmtplib>=1.1.0,<4.0.0"
pip install "jinja2>=3.0.0,<4.0.0"

# 工具库
pip install "python-dotenv>=0.19.0,<2.0.0"
